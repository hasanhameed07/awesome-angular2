...
* [Angular 2 Dashboard Starter](https://github.com/hasanhameed07/angular2-dashboard-starter) - Ready to use dashboard starter project based on Angular 2 and utilizes AdminLTE 2 theme.
